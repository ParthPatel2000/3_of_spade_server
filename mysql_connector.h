...
public:
    ...
    MySQLConnector(std::string host, std::string user, std::string password, std::string database); // parameterized constructor
    ...
    bool connect();                                       // connect to the mysql server
